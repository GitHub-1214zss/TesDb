...
public class ReadExcel {
     ...
     * @return
     */
    public List<User> getExcelInfo(MultipartFile mFile) throws IOException {
        String fileName = mFile.getOriginalFilename();// 获取文件名
        System.out.println(fileName);
            if (!validateExcel(fileName)) {// 验证文件名是否合格
                System.out.println("文件名否合格");
                return null;
            }
            boolean isExcel2003 = true;// 根据文件名判断文件是2003版本还是2007版本
            if (isExcel2007(fileName)) {
                System.out.println("不是2013版本");
                isExcel2003 = false;
            }
     ...
     * @throws
     */
    public List<User> createExcel( MultipartFile mFile, boolean isExcel2003) throws IOException {
